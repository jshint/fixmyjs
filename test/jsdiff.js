...
module.exports = {
  ...
  diff: function (o, n) {
    ...
    for (i = 0; i < n.length - 1; i += 1) {
      if (typeof n[i].text !== "undefined" && typeof n[i + 1].text === "undefined"
          && n[i].row + 1 < o.length && typeof o[n[i].row + 1].text === "undefined" && n[i + 1] === o[n[i].row + 1]) {
    ...
    for (i = n.length - 1; i > 0; i -= 1) {
      if (typeof n[i].text !== "undefined" && typeof n[i - 1].text === "undefined"
          && n[i].row > 0 && typeof o[n[i].row - 1].text === "undefined" && n[i - 1] === o[n[i].row - 1]) {
        n[i - 1] = { text: n[i - 1], row: n[i].row - 1 };
        o[n[i].row - 1] = { text: o[n[i].row - 1], row: i - 1 };
      }
    }
